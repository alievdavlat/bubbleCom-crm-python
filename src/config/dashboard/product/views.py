...
from .forms import TypeForm, CategoryForm, ProductForm, ProductionProductForm, ProductInfoForm
...
def add_production_product(request):
    ...
    return TemplateResponse(request, 'products/add_production_product.html', {'form': form})
